...
const DualStateButton2 = memo(function DualStateButton2({
  title,
  href = "#",
  target = "_self",
}) {
  ...
  return (
    <a 
      ...
      target={target}
      onClick={handleClick}
      className="group relative flex flex-row gap-0 items-start justify-start transition duration-500 will-change-transform"
      ...
      >
        ...
        >
          <div
            ...
            style={{ transform: 'translateZ(0)' }}
          >
            <span className="text-white text-[16px] tracking-[-0.64px]">
              {title}
            </span>
          </div>
        </div>
...
export default DualStateButton2;